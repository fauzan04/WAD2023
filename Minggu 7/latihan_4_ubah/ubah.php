...
if (isset($_POST["submit"])) {
    ...
    $query = "UPDATE toko_buah_aliong SET nama_buah = '$nama_buah', harga = '$harga', tanggal_kadaluarsa = '$tanggal_kadaluarsa' WHERE kode_buah = '$kode_buah'";
...
<head>
    ...
    <title>Ubah data toko buah aliong</title>
    <style>
        body {
...
<body>
    <h1>Ubah data toko buah aliong</h1>
    <form action="ubah.php?kode_buah=<?= $barang['kode_buah'] ?>" method="post">
